...
class GenerateOrgDomainValidationRequest extends Request implements HasBody
{
    ...
    {
        return "management/v1/orgs/me/domains/{$this->domain}/validation/_generate";
    }

    protected function defaultBody(): array
    {
        return ['type' => 'DOMAIN_VALIDATION_TYPE_DNS'];
    }
}
