...
function backupScheduleFakes(array $overrides = []): array
{
    ...
    return array_merge([
        ...
        '*get deployment -n larakube-shared -o jsonpath*' => Process::result(output: 'forgejo forgejo-runner ocis-drive-luchtech-dev stalwart chat-synapse chat-cinny chat-coturn chat-synapse-db webmail-bulwark grafana prometheus-server loki'),
