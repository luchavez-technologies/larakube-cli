...
test('hasInstanceAwareRemoval() only allowlists the tools with real per-instance teardown', function (): void {
    ...
    $expectedTrue = [ClusterTool::DATA, ClusterTool::NOTES, ClusterTool::CRM, ClusterTool::DESIGN, ClusterTool::PASTE, ClusterTool::SIGN, ClusterTool::FLOW, ClusterTool::LINK, ClusterTool::ANALYTICS, ClusterTool::SHEETS];
