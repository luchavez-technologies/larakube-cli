...
test('scout driver has correct labels', function (): void {
...
test('scout driver has correct ports', function (): void {
...
test('scout driver pod names', function (): void {
...
test('scout driver select options are valid', function (): void {
